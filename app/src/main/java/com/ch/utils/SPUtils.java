...
public final class SPUtils {
    ...
    public void put(final String key, final Map value){
        //Gson gson = new Gson();
        String jsonStr =StringUtils.transMapToString(value);

        put(key,jsonStr,true);
    }
    public Map getMap(final String key)
    {
        ...
        if(value==null||value.trim().isEmpty())
            return null;
        return (Map)StringUtils.transStringToMap(value);
    }
    /**
