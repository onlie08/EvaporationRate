...
public class AutoEditTextView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void initData(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        downLineDefaultColor = typeArray.getColor(R.styleable.AutoEditTextView_downLineDefaultColor, getColor(R.color.textcolorTip));
        downLineFocusColor = typeArray.getColor(R.styleable.AutoEditTextView_downLineFocusColor, getColor(R.color.colorAccent));
        typeArray.recycle();
        setBackground(null);
        initPaint();
    }
...
//                    isShowPass ? getDrawable(R.mipmap.close) : getDrawable(R.mipmap.open), getCompoundDrawables()[3]);
            setCompoundDrawables(getDrawable(R.mipmap.icon_alarm_selected), null,
                    isShowPass ? getDrawable(R.mipmap.close) : getDrawable(R.mipmap.open), null);
        }
    }
